...
export function JobsBrowser({
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="sticky top-[64px] z-20 -mx-4 border-b border-border-subtle bg-[rgba(246,247,251,0.96)] px-4 py-3 backdrop-blur sm:-mx-6 sm:px-6 lg:static lg:mx-0 lg:border-none lg:bg-transparent lg:px-0 lg:py-0">
      ...
      <section className="space-y-4">
        ...
        {jobs?.map((job) => (
          <JobBrowseCard key={job.id} job={job} detailHrefBase={detailHrefBase} />
        ))}
      </section>
    </div>
  );
