...
export async function MobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border-subtle bg-[rgba(255,255,255,0.94)] px-2 pb-[calc(env(safe-area-inset-bottom)+0.4rem)] pt-2 shadow-[0_-18px_36px_rgba(15,23,42,0.08)] backdrop-blur dark:bg-[rgba(17,24,39,0.94)] lg:hidden">
